...
static const cy_stc_ble_customs_t cy_ble_customs[0x01u] = {
    ...
    /* DemoNixieService service */
    {
        0x0010u, /* Handle of the DemoNixieService service */ 
        {

            /* animSpec characteristic */
            {
                0x0012u, /* Handle of the animSpec characteristic */ 
            ...
            /* timeSpec characteristic */
            {
                0x0015u, /* Handle of the timeSpec characteristic */ 
