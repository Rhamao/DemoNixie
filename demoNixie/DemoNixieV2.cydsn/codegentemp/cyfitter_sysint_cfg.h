...
/* ARM CM4 */
    ...
    #define Timer_ISR__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t Timer_ISR_cfg;

    #define dataIsr__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t dataIsr_cfg;

#endif /* ((__CORTEX_M == 4) && (CY_CORE_ID == 0)) */

/* ARM CM0+ */
#if (((__CORTEX_M == 0) && (CY_CORE_ID == 0)))
    #define DBG_SCB_IRQ__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t DBG_SCB_IRQ_cfg;
