...
#define RTC_1_INITIAL_IRQ_STATUS        (0u)
...
#define RTC_1_INITIAL_DATE_HOUR         (23u)
#define RTC_1_INITIAL_DATE_HOUR_FORMAT  (CY_RTC_24_HOURS)
#define RTC_1_INITIAL_DATE_DOW          (5u)
#define RTC_1_INITIAL_DATE_DOM          (25u)
#define RTC_1_INITIAL_DATE_MONTH        (6u)
