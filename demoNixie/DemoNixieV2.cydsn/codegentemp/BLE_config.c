...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x0Au, 0x09u, 0x44u, 0x65u,
        0x6Du, 0x6Fu, 0x4Eu, 0x69u, 0x78u, 0x69u, 0x65u,
...
cy_stc_ble_gapp_scan_rsp_data_t cy_ble_scanRspData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        ...
        0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u,
        0x4Eu, 0x2Bu, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
        0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
        0x00u, 0x00u, 0x00u }, /* uint8_t scan_rsp_data[CY_BLE_MAX_SCAN_RSP_DATA_LEN] */ 
        0x12u, /* uint8_t scan_rsp_data_length */ 
    },
};
...
static uint8_t cy_ble_attValues[0x56u] = {
    /* Device Name */
    (uint8_t)'D', (uint8_t)'e', (uint8_t)'m', (uint8_t)'o', (uint8_t)'N', (uint8_t)'i', (uint8_t)'x', (uint8_t)'i',
(uint8_t)'e', 
    ...
    /* animSpec */
    0x00u, 0xFFu, 0xFFu, 0xFFu, 0x00u, 0x00u, 0x00u, 0x00u, 0xFFu, 0xFFu, 0xFFu, 0x00u, 0x00u, 0x00u, 0x00u, 0xFFu, 0xFFu,
0xFFu, 0x00u, 0x00u, 0x00u, 0x00u, 

    /* Characteristic User Description */
    (uint8_t)'R', (uint8_t)'G', (uint8_t)'B', (uint8_t)' ', (uint8_t)'c', (uint8_t)'o', (uint8_t)'l', (uint8_t)'o',
(uint8_t)'r', (uint8_t)' ', (uint8_t)'s', (uint8_t)'p', (uint8_t)'e', (uint8_t)'c', 

    /* timeSpec */
    0x00u, 0x00u, 0x00u, 

    /* Characteristic User Description */
    (uint8_t)'M', (uint8_t)'i', (uint8_t)'s', (uint8_t)'e', (uint8_t)' ', (uint8_t)'a', (uint8_t)' ', (uint8_t)'j',
(uint8_t)'o', (uint8_t)'u', (uint8_t)'r', (uint8_t)' ', (uint8_t)'d', (uint8_t)'e', (uint8_t)' ', (uint8_t)'l',
(uint8_t)'\'', (uint8_t)'h', (uint8_t)'e', (uint8_t)'u', (uint8_t)'r', (uint8_t)'e', 
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* DemoNixieService */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0x4Eu, 0x2Bu, 0x00u, 0x00u },
};
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Cu] = {
    ...
    { 0x0010u, (void *)&cy_ble_attUuid128[0] }, /* DemoNixieService UUID */
    { 0x0016u, (void *)&cy_ble_attValues[25] }, /* animSpec */
    { 0x000Eu, (void *)&cy_ble_attValues[47] }, /* Characteristic User Description */
    { 0x0003u, (void *)&cy_ble_attValues[61] }, /* timeSpec */
    { 0x0016u, (void *)&cy_ble_attValues[64] }, /* Characteristic User Description */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x16u] = {
    ...
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x000E0001u /* rd,wr,wwr */, 0x0013u, {{0xDB56u, NULL}}                           },
    { 0x0012u, 0xDB56u /* animSpec                            */, 0x010E0101u /* rd,wr,wwr */, 0x0013u, {{0x0016u, (void *)&cy_ble_attValuesLen[8]}} },
    { 0x0013u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd        */, 0x0013u, {{0x000Eu, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0014u, 0x2803u /* Characteristic                      */, 0x000E0001u /* rd,wr,wwr */, 0x0016u, {{0x7AF3u, NULL}}                           },
    { 0x0015u, 0x7AF3u /* timeSpec                            */, 0x010E0101u /* rd,wr,wwr */, 0x0016u, {{0x0003u, (void *)&cy_ble_attValuesLen[10]}} },
    { 0x0016u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd        */, 0x0016u, {{0x0016u, (void *)&cy_ble_attValuesLen[11]}} },
};
