// ======================================================================
// DemoNixieV2.v generated from TopDesign.cysch
// 06/25/2020 at 23:28
...
// bIncludeDriverToComponent_v1_0(PDL_DRIVER_NAME=ble, PDL_DRIVER_REQ_VERSION=2.0.0, PDL_DRIVER_SUBGROUP=Stack library, PDL_DRIVER_VARIANT=Profile - Host CM4 / Ctrl CM4, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=bIncludeDriverToComponent_v1_0, CY_CONFIG_TITLE=IncludeBleLibs, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BLE:IncludeBleLibs, CY_INSTANCE_SHORT_NAME=IncludeBleLibs, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ble, CY_PDL_DRIVER_REQ_VERSION=2.0.0, CY_PDL_DRIVER_SUBGROUP=Stack library, CY_PDL_DRIVER_VARIANT=Profile - Host CM4 / Ctrl CM4, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=BLE_IncludeBleLibs, )
...
`ifdef WARP
`define CY_BLK_DIR "F:\psoc\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0"
`include "F:\psoc\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "F:\psoc\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0"
`include "F:\psoc\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "F:\psoc\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal"
`include "F:\psoc\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`else
`define CY_BLK_DIR "F:\psoc\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal"
`include "F:\psoc\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`endif
...
// TCPWM_PWM_PDL_v1_0(ClockPrescaler=0, Compare0=1, Compare1=16384, CountInput=7, CountInputMasked=3, DeadClocks=0, EnableCompareSwap=false, EnablePeriodSwap=false, InterruptSource=2, InvertPwm=false, InvertPwm_n=false, KillInput=7, KillInputMasked=3, KillMode=2, Period0=1, Period1=32768, PwmAlignment=0, PwmMode=4, ReloadInput=7, ReloadInputMasked=3, Resolution=16, RunMode=0, StartInput=7, StartInputMasked=3, SwapInput=7, SwapInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_PWM_PDL_v1_0, CY_CONFIG_TITLE=PWM_COM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_COM, CY_INSTANCE_SHORT_NAME=PWM_COM, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=PWM_COM, )
...
// TCPWM_PWM_PDL_v1_0(ClockPrescaler=0, Compare0=1, Compare1=16384, CountInput=7, CountInputMasked=3, DeadClocks=0, EnableCompareSwap=false, EnablePeriodSwap=false, InterruptSource=1, InvertPwm=false, InvertPwm_n=false, KillInput=7, KillInputMasked=3, KillMode=2, Period0=1, Period1=32768, PwmAlignment=0, PwmMode=4, ReloadInput=7, ReloadInputMasked=3, Resolution=16, RunMode=0, StartInput=7, StartInputMasked=3, SwapInput=7, SwapInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_PWM_PDL_v1_0, CY_CONFIG_TITLE=TIMER, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=TIMER, CY_INSTANCE_SHORT_NAME=TIMER, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=TIMER, )
...
// RTC_PDL_v2_0(DateFormat=0, DaylightSavingsTimeEn=false, DayOfMonth=25, DayOfMonthDstStart=22, DayOfMonthDstStop=22, DayOfWeek=5, DayOfWeekDstStart=1, DayOfWeekDstStop=1, DstDateType=0, EnableRtcInterrupt=false, Hour=23, HoursDstStart=0, HoursDstStop=0, Month=6, MonthDstStart=3, MonthDstStop=10, RemoveIntr=true, TimeFormat=0, TimeResetOnStart=false, WeekOfMonthDstStart=6, WeekOfMonthDstStop=6, Year=20, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=RTC_PDL_v2_0, CY_CONFIG_TITLE=RTC_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=RTC_1, CY_INSTANCE_SHORT_NAME=RTC_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=rtc, CY_PDL_DRIVER_REQ_VERSION=2.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=RTC_1, )
...
module top ;
    ...
    TCPWM_PWM_PDL_v1_0_3 PWMDriver (
        .kill(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpFB_0__LedDriverClockPin_net;
	wire [0:0] tmpIO_0__LedDriverClockPin_net;
	electrical [0:0] tmpSIOVREF__LedDriverClockPin_net;
	...
	cy_mxs40_gpio_v1_0
		...
		LedDriverClockPin
		 (.oe({1'b1}),
		  .y({Net_89}),
		  .fb({tmpFB_0__LedDriverClockPin_net[0:0]}),
		  .io({tmpIO_0__LedDriverClockPin_net[0:0]}),
		  .siovref(tmpSIOVREF__LedDriverClockPin_net));


	wire [0:0] tmpFB_0__LedDriverClockComOut_net;
	wire [0:0] tmpIO_0__LedDriverClockComOut_net;
	electrical [0:0] tmpSIOVREF__LedDriverClockComOut_net;
	...
	cy_mxs40_gpio_v1_0
		...
		LedDriverClockComOut
		 (.oe({1'b1}),
		  .y({Net_102}),
		  .fb({tmpFB_0__LedDriverClockComOut_net[0:0]}),
		  .io({tmpIO_0__LedDriverClockComOut_net[0:0]}),
		  .siovref(tmpSIOVREF__LedDriverClockComOut_net));
	...
	wire [0:0] tmpFB_0__LedDriverLatchOut_net;
	wire [0:0] tmpIO_0__LedDriverLatchOut_net;
	electrical [0:0] tmpSIOVREF__LedDriverLatchOut_net;
	...
	cy_mxs40_gpio_v1_0
		...
		LedDriverLatchOut
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedDriverLatchOut_net[0:0]}),
		  .io({tmpIO_0__LedDriverLatchOut_net[0:0]}),
		  .siovref(tmpSIOVREF__LedDriverLatchOut_net));


	wire [0:0] tmpFB_0__LedDriverSdaOut_net;
	wire [0:0] tmpIO_0__LedDriverSdaOut_net;
	electrical [0:0] tmpSIOVREF__LedDriverSdaOut_net;
	...
	cy_mxs40_gpio_v1_0
		...
		LedDriverSdaOut
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedDriverSdaOut_net[0:0]}),
		  .io({tmpIO_0__LedDriverSdaOut_net[0:0]}),
		  .siovref(tmpSIOVREF__LedDriverSdaOut_net));
	...
	wire [0:0] tmpFB_0__FLASHINFO_net;
	wire [0:0] tmpIO_0__FLASHINFO_net;
	electrical [0:0] tmpSIOVREF__FLASHINFO_net;
	...
	cy_mxs40_gpio_v1_0
		...
		FLASHINFO
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__FLASHINFO_net[0:0]}),
		  .io({tmpIO_0__FLASHINFO_net[0:0]}),
		  .siovref(tmpSIOVREF__FLASHINFO_net),
		  .annotation({Net_70}));


	wire [0:0] tmpFB_0__FLASHWRITE_net;
	wire [0:0] tmpIO_0__FLASHWRITE_net;
	electrical [0:0] tmpSIOVREF__FLASHWRITE_net;
	...
	cy_mxs40_gpio_v1_0
		...
		FLASHWRITE
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__FLASHWRITE_net[0:0]}),
		  .io({tmpIO_0__FLASHWRITE_net[0:0]}),
		  .siovref(tmpSIOVREF__FLASHWRITE_net),
		  .annotation({Net_70}));


    RTC_PDL_v2_0_6 RTC_1 ();
