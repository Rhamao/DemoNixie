...
#define CY_BLE_CONFIG_GATT_DB_MAX_VALUE_LEN         (0x0016u)
 ...
 */
#define CY_BLE_DEMONIXIESERVICE_SERVICE_INDEX   (0x00u) /* Index of DemoNixieService service in the cy_ble_customs array */
#define CY_BLE_DEMONIXIESERVICE_ANIMSPEC_CHAR_INDEX   (0x00u) /* Index of animSpec characteristic */
#define CY_BLE_DEMONIXIESERVICE_ANIMSPEC_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_DEMONIXIESERVICE_TIMESPEC_CHAR_INDEX   (0x01u) /* Index of timeSpec characteristic */
#define CY_BLE_DEMONIXIESERVICE_TIMESPEC_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CY_BLE_DEMONIXIESERVICE_SERVICE_HANDLE   (0x0010u) /* Handle of DemoNixieService service */
#define CY_BLE_DEMONIXIESERVICE_ANIMSPEC_DECL_HANDLE   (0x0011u) /* Handle of animSpec characteristic declaration */
#define CY_BLE_DEMONIXIESERVICE_ANIMSPEC_CHAR_HANDLE   (0x0012u) /* Handle of animSpec characteristic */
#define CY_BLE_DEMONIXIESERVICE_ANIMSPEC_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_DEMONIXIESERVICE_TIMESPEC_DECL_HANDLE   (0x0014u) /* Handle of timeSpec characteristic declaration */
#define CY_BLE_DEMONIXIESERVICE_TIMESPEC_CHAR_HANDLE   (0x0015u) /* Handle of timeSpec characteristic */
#define CY_BLE_DEMONIXIESERVICE_TIMESPEC_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0016u) /* Handle of Characteristic User Description descriptor */
